<?php
// FIXED: was 'include 25ESKCS006\DAY10\db_connect.php;' — an absolute-ish
// Windows path from your own machine that won't exist on any server or
// once this is pushed to GitHub. db_connect.php lives in the same folder,
